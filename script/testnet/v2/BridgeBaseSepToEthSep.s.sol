...
// forge script script/testnet/v2/BridgeBaseSepToEthSep.s.sol:BridgeBaseSepToEthSep --broadcast -vvvv

/**
 * @title BridgeBaseSepToEthSep
 * @author Mainstreet Labs
 * @notice This script bridges msUSDV2 from Base Sepolia to Ethereum Sepolia
 */
contract BridgeBaseSepToEthSep is Script {
    ...
    function run() public {
        ...
        msUSDToken.sendFrom{value: nativeFee}(
            account,                   // from
            SEPOLIA_LZ_CHAIN_ID_V1,     // dstChainId  
