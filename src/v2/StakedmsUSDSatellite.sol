 ...
 * @notice The satellite chain implementation of StakedmsUSD, deployed on all non-home chains to enable cross-chain
 * transfers of the StakedmsUSD vault token. This contract uses LayerZero's standard burn-and-mint mechanism
 ...
 * in conjunction with the home chain StakedmsUSD contract to provide seamless cross-chain token transfers while
...
contract StakedmsUSDSatellite is UUPSUpgradeable, OFTUpgradeable {
    ...
    /**
     * @notice Initializes StakedmsUSD's inherited upgradeables.
